...
| Step 4 		                         | 	... applying filters to the list of properties?	                                                     | DisplayListedPropertiesController	          | Controller: Coordinates the application of filter criteria, interacting with the service to obtain filtered listings.                                                                                                       | 
| Step 5  		                        | 	... retrieving filtered property listings?	            | DisplayListedPropertiesService         | Information Expert: Has the logic to access and return filtered data, interacting with the repository based on the specified criteria.                                                                                      |                                                                                        |
| 			  	                            | 	... applying filter criteria?	                                      | ListingRepository                  | Information Expert: Responsible for applying filter criteria directly on the stored listings.                                                                                                                               |
| Step 6                            | ... displaying the filtered list of properties?		                                     | DisplayListedPropertiesView                  | Pure Fabrication: Renders and presents the filtered list of properties to the user based on data returned by the Controller.|
